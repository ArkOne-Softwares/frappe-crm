<template>
  ...
  <div class="flex flex-row justify-around items-stretch h-full border-t">
    <div
      class="flex flex-col w-full max-w-[400px] h-full flex-1 items-stretch border-r bg-blue-50"
    >
    ...
    <div class="flex w-full h-full flex-1 items-stretch">
      ...
      >
        ...
        <template #default="{ tab }">
          ...
          />
          <Activities
            v-if="tab.label === 'Comments' || tab.name === 'Notes'"
            ref="activities"
            doctype="Contact"
            :title="tab.name"
            :tabs="tabs"
