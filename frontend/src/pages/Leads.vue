  ...
  >
    <template #title="{ titleField, itemName }">
      <div class="flex items-center gap-2">
        ...
        <div v-else-if="titleField === 'lead_name' && getRow(itemName, titleField).label">
          <Avatar
            class="flex items-center"
        ...
        <div
          v-else-if="
            titleField === 'lead_owner' && getRow(itemName, titleField).full_name
          "
        >
          <Avatar
            class="flex items-center"
...
const rows = computed(() => {
  ...
  if (leads.value.data.view_type === "group_by") {
    ...
    return getGroupedByRows(leads.value?.data.data, leads.value?.data.group_by_field);
